...
Examples:
  ...
  python transform_canvas.py --form form.json --v3 submission.json --output result.json
  python transform_canvas.py -f form.json -v submission.json -o result.json --log-level DEBUG
        """
    )
    ...
    parser.add_argument(
        ...
        dest='log_file',
        default=None,
        help='Path for log file (default: transform_canvas.log)'
    )
