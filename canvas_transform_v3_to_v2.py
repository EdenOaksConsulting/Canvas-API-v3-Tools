...
LOG_CONFIG = {
    ...
    'file': 'canvas_transform_v3_to_v2.log',  # Log file name
}
...
def setup_logging(log_file=None, log_level='INFO'):
    ...
    if log_file is None:
        log_file = LOG_CONFIG.get('file', 'canvas_transform_v3_to_v2.log')
...
def main(form_file=None, v3_file=None, output_file=None, log_file=None, log_level=None):
    """
    Transform Canvas v3 JSON format to v2 format.
    
    Args:
        form_file: Path to the form structure JSON file (Canvas_Sample_Form_Nested.json)
        v3_file: Path to the v3 submission JSON file (Canvas_v3.json)
        output_file: Path for the output transformed JSON file
    ...
    if form_file is None:
        form_file = 'Canvas_Sample_Form_Nested.json'
    if v3_file is None:
        v3_file = 'Canvas_v3.json'
    if output_file is None:
        output_file = 'Canvas_v3_transformed.json'
    
    # Load the files
    logger.info("Loading files...")
    logger.info(f"Form file: {form_file}")
    logger.info(f"V3 file: {v3_file}")
    form_data = load_json_file(form_file)
    v3_data = load_json_file(v3_file)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Transform Canvas v3 JSON format to v2 format',
...
Examples:
  ...
  python canvas_transform_v3_to_v2.py -f form.json -v submission.json -o result.json --log-level DEBUG
        """
    )
    ...
    parser.add_argument(
        ...
        dest='form_file',
        default=None,
        help='Path to form structure JSON file (default: Canvas_Sample_Form_Nested.json)'
    )
    ...
    parser.add_argument(
        ...
        dest='v3_file',
        default=None,
        help='Path to v3 submission JSON file (default: Canvas_v3.json)'
    )
    ...
    parser.add_argument(
        ...
        dest='output_file',
        default=None,
        help='Path for output transformed JSON file (default: Canvas_v3_transformed.json)'
    )
    ...
    parser.add_argument(
        ...
        dest='log_file',
        default=None,
        help='Path for log file (default: canvas_transform_v3_to_v2.log)'
    )
